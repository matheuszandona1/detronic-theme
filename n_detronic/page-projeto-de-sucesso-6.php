...
<img src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/pag-2/FOTO - PEB - FORMATO BANNER.jpg" alt="" style="width:100%">

<div class="container sucesso text-center d-flex">
    <span class="energia-sub ">
      Paraopeba / MG
    </span>
    <span class="faq-sub">Usina Fotovoltaica de 3.490 kWp de potência.</span>
    <div class="sucesso-div">
        <div class="sucesso-div-1">
            <span class="parc-project">
				Usina em implantação em Paraopeba/MG. A energia gerada pela usina será entregue ao consórcio da Detronic Energia para ser compartilhada com múltiplas empresas, proporcionando ao consumidor final a possibilidade de usufruir de uma energia limpa e renovável e mais acessível.
			</span>
        </div>
        <div class="sucesso-div-2">
            ...
            <div class="quadro-sucesso-dir">
                <span class="sucesso-dir">DTC0129 – PEB01</span>
                <span class="sucesso-dir">6.464 módulos de 540 Wp</span>
                <span class="sucesso-dir">12 inversores de 200 kW e</span>
                <span class="sucesso-dir">1 inversor de 100 kW</span>
                <span class="sucesso-dir">3.490 kWp</span>
                <span class="sucesso-dir">2.500 kW</span>
                <span class="sucesso-dir">60. 549 m²</span>
                <span class="sucesso-dir">Paraopeba/MG</span>
                <span class="sucesso-dir">568 MWh/mês</span>
            </div>
        </div>
    </div>
    <div class="usinas-col">
        <div class="usinas-row">
            <img class="img-resize" src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/pag-2/PEB-2.png"
                 alt="">
            <img class="img-resize" src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/pag-2/PEB 3.JPG">
        </div>
    </div>
