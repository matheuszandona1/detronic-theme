            ...
            <ul class="navbar-nav new-navbar">
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link active" aria-current="page" id="logo-nav" href="<?php echo get_bloginfo('home'); ?>">
                        ...
                        <img src="<?php echo get_template_directory_uri() ?>/icons/detronic.png" width="180" height="49" style="margin-right: 60px;">
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link btn-home" href="<?php echo get_bloginfo('home'); ?>" id="nav-txt">Ver plano residencial</a>

                </li>

                <li class="nav-item">

                    <a class="nav-link btn-a-detronic" href="<?php echo get_bloginfo('home'); ?>/a-detronic-energia" id="nav-txt">Ver plano comercial</a>
