...
<img src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/pag-2/FULLBANNER - PROJETO 11 - CAETANOPOLIS-MG.jpg" alt="" style="width:100%;">
    ...
    <div class="sucesso-div">
        <div class="sucesso-div-1">
            <span class="parc-project">
				Usina em implantação em Caetanópolis/MG. A energia gerada pela usina será entregue ao consórcio da Detronic Energia para ser compartilhada com múltiplas empresas, proporcionando ao consumidor final a possibilidade de usufruir de uma energia limpa e renovável e mais acessível. 
			</span>
        </div>
        <div class="sucesso-div-2">
            ...
            <div class="quadro-sucesso-dir">
                <span class="sucesso-dir">DTC0048 – CAE03</span>
                ...
                <span class="sucesso-dir">61.122 m²</span>
                <span class="sucesso-dir">Caetanópolis /MG</span>
                <span class="sucesso-dir">554,08 MWh/Mês</span>
            </div>
        </div>
    </div>
	<div class="usinas-col">
        <div class="usinas-row">
            <img class="img-resize" src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/pag-2/CAE03FOTO1.jpg" alt="">
            <img class="img-resize" src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/pag-2/CAE 03 FOTO 2.JPG" alt="">
            <img class="img-resize" src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/pag-2/CAE 03 FOTO 3.JPG" alt="">
        </div>
    </div>
</div>
