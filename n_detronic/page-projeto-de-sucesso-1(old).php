...
<img src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/new_banner_moc.jpg" alt="" style="width:100%;">

<div class="container sucesso text-center d-flex">
    <span class="energia-sub ">
        Montes Claros/MG
    </span>
    <span class="faq-sub">Usina fotovoltaica 3,2 MWp</span>
    <div class="sucesso-div">
        <div class="sucesso-div-1">
            <span class="parc-project">Localizada na cidade de Montes Claros tem capacidade média de geração de
            527.875 kWh/mês. A energia gerada foi locada para que múltiplos consumidores se beneficiem
            da geração, no modelo de negócio Geração Compartilhada.
            A estrutura implantada foi a tracker da ALION Energy que utiliza base concretada, não exigindo
            fundação e permitindo a acompanhar o relevo.</span>
        </div>
        <div class="sucesso-div-2">
            ...
            <div class="quadro-sucesso-dir">
                <span class="sucesso-dir">DTC0033- MOC Duceu</span>
                <span class="sucesso-dir">8.000 módulos de 400Wp</span>
                <span class="sucesso-dir">20 inversores de 125 kW</span>
                <span class="sucesso-dir">3.200 kWp</span>
                <span class="sucesso-dir">2.500 kW</span>
                <span class="sucesso-dir">70.000 m²</span>
                <span class="sucesso-dir">Montes Claros/MG</span>
                <span class="sucesso-dir">508 MWh/mês</span>
            </div>
        </div>
    </div>
    <div class="usinas-col">
        <div class="usinas-row">
            <img class="img-resize" src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/pag1/DJI_0419.jpg"
                 alt="">
            <img class="img-resize" src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/pag1/DJI_0424.jpg"
                 alt="">
            <img class="img-resize" src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/pag1/DJI_0435.jpg"
                 alt="">
        </div>
    </div>
