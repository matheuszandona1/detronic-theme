...
<div class="container sucesso text-center d-flex">
    ...
    <span class="faq-sub">Usina Fotovoltaica com 2.980 kWp de potência.</span>
    <div class="sucesso-div">
        <div class="sucesso-div-1">
            <span class="parc-project">
				Usina implantada em Conceição da Barra/ES para atender a unidades de uma cooperativa de crédito no modelo de auto consumo remoto. A energia gerada pelas usinas trará a auto suficiência em produção de energia às unidades consumidoras.
			</span>
        </div>
        <div class="sucesso-div-2">
            <div class="quadro-sucesso-esq">
                ...
                <span class="sucesso-esq">Nº de inversores<br><br><br><br></span>
                <span class="sucesso-esq"><br></span>
                <span class="sucesso-esq">Potência Pico</span>
                <span class="sucesso-esq">Potência do Inversor</span>
                <span class="sucesso-esq">Área do terreno</span>
                <span class="sucesso-esq">Localização</span>
                <span class="sucesso-esq">Geração Média</span>
            </div>
            <div class="quadro-sucesso-dir">
                <span class="sucesso-dir">DTC 0035 Sicoob</span>
                <span class="sucesso-dir">8.908 de 335 Wp</span>
                <span class="sucesso-dir">8 inversores de 50Kw<br>8 inversores de 110kW<br>2 inversores de 60kW<br>3 inversores de 125kW<br></span>
                <span class="sucesso-dir">2.983 kWp</span>
                <span class="sucesso-dir">2.320 kW</span>
                <span class="sucesso-dir">32.244 m²</span>
                <span class="sucesso-dir">4.088 m²</span>
                <span class="sucesso-dir">Conceição da Barra /ES</span>
                <span class="sucesso-dir">332,77 MWh/mês</span>
            </div>
        </div>
    </div>
    <div class="usinas-col">
		...
		<div class="usinas-row">
            <img class="img-resize" src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/sicoob/SICOOB1.jpg"
                 alt="">
            <img class="img-resize"
                 src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/sicoob/SICOOB2.jpg">
        </div>
        <div class="usinas-row">
            <img class="img-resize"
                 src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/sicoob/SICOOB3.jpg">
