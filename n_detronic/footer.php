...
<div class="reflexao" id="footer-scroll">
    <div class="container reflex-cont">
        <span class="reflex-main">Reflexão do dia</span>
        <span class="reflex-sub"><?=$versiculo_dia['versiculo']?></span>
        <br>
        <span class="reflex-dia"><?=$versiculo_dia['mensagem']?></span>
    </div>
</div>
<!-- end /.reflexao -->
...
<div class="footer">
    ...
    <div class="footer-1">
        ...
        <img src="<?php echo get_template_directory_uri() ?>/icons/detronic.png" style="width: 250px; height: 60px;">

        <span class="sol-mtitle">soluções em energia limpa</span>
...
<div class="footer-top">
    ...
    <div class="end-cont">
        ...
        <div class="address">
            ...
            <a href="https://goo.gl/maps/BsQJRZD6AzZXtECT8" style="text-decoration: none; color: gray;">
                    <span>Rua Ministro Orozimbo Nonato,<br>

                   n º 102 – 17º Andar - Torre A.<br>

                    CEP: 34.006-053.<br>

                    Vila da Serra/Nova Lima</span>
            </a>
        ...
        <div class="contact">
            ...
            <div class="hub-sol">
				<?php
				/*
                <a href="<?php echo get_bloginfo('home'); ?>" style="text-decoration: none;">
                    <span class="hub-title">home</span>
                </a>
                <a href="<?php echo get_bloginfo('home'); ?>/detronic" style="text-decoration: none;">
                    <span class="hub-title">a detronic</span>
                </a>
                <a href="<?php echo get_bloginfo('home'); ?>/hub-de-energia" style="text-decoration: none;">
                    <span class="hub-title">hub de energia</span>
                </a>
                <a href="<?php echo get_bloginfo('home'); ?>/blog" style="text-decoration: none;">
                    <span class="hub-title">blog</span>
                </a>
				
                <span class="hub-title">soluções</span>

                <div class="sol-topics">
                    <a href="<?php echo get_bloginfo('home'); ?>/reducao-de-ate-20-na-conta"
                       style="text-decoration: none;">
                        <div class="sol-topics-txt">Redução na conta</div>
                    </a>
                    <a href="<?php echo get_bloginfo('home'); ?>/parceiros-investidores" style="text-decoration: none;">
                        <div class="sol-topics-txt">Parceiros/Investidores</div>
                    </a>
                    <a href="<?php echo get_bloginfo('home'); ?>/instalacao-usina-solar"
                       style="text-decoration: none;">
                        <div class="sol-topics-txt">Instalação de Usina Solar</div>
                    </a>
                </div>
				*/?>
                <div class="contato">
                    ...
                    <div class="contato-list">
                        <div class="contact">
                            <div class="contact-align">
                                <img src="<?php echo get_template_directory_uri(); ?>/icons/footer/icon-2.png" alt=""  style="max-width:15px;">
                                <div class="contact-align-2">
                                    <span>Telefone:</span>

                                    <a href="tel:+553133273543"
                                       style="font-weight: bold; color: gray; text-decoration: none;">
                                        +55 (31) 3327-3543</a>
                                </div>
                            </div>
                            <div class="contact-align">
                                <img src="<?php echo get_template_directory_uri(); ?>/icons/footer/icon-1.png" alt=""  style="max-width:15px;">
                                <div class="contact-align-2">
                                    <span>Whatsapp</span>

                                    <a href="https://api.whatsapp.com/send?phone=5531996962560&text=Oi,%20tudo%20bem%20?%20Estou%20no%20seu%20site%20agora.%20Voc%C3%AA%20pode%20me%20ajudar%20?"                                     style="font-weight: bold; color: gray; text-decoration: none;">
                                    +55 (31) 99696-2560</a>
                                </div>
                            </div>
                            <div class="contact-align">
                                <img src="<?php echo get_template_directory_uri(); ?>/icons/footer/icon-3.png" alt=""  style="max-width:15px;padding-top: 5px;">
                                <div class="contact-align-2">
                                    <span>E-mail:</span>

                                    <a href="mailto: contato@detronicenergia.com"
                                       style="font-weight: bold; color: gray; text-decoration: none;">contato@detronicenergia.com</a>
				...
				<div class="row" style="margin-top:30px;clear:both;text-align:center;border:0px solid red;">
				  <div class="col-12">
					<span style="font-size:10pt;"><?=date('Y');?> | Detronic Energia. Todos os direitos reservados.&nbsp;
				  </div>
				  <div class="col-12" style="margin-top:30px;">
					<a class="" href="<?php echo get_bloginfo('home'); ?>/politica-de-privacidade" style="font-family: 'Work Sans', sans-serif;">
						POLÍTICA DE PRIVACIDADE
					</a>
				  </div>
				  <div class="col-12" style="margin:30px 0 50px 0;">
					<a class="" href="https://www.agenciacuringa.com.br/" target="_blank">
						<img src="<?php echo get_template_directory_uri() ?>/icons/curinga.png" style="max-width:30px;">
					</a>
				  </div>
				</div>
            </div>
...
<!-- Desktop -->
	<div class="container-fluid footer-obrigado">
		
<div class="container cont-002">
    <div class="test0001">
        <div class="col contact-deal">
            <img src="<?php echo get_template_directory_uri(); ?>/icons/detronic-logo.png" alt=""
        ...
        <div class="col col-footer">
            <span class="footer-txt-01">SOLUÇÕES EM ENERGIA LIMPA</span>
            <div class="footer-align">
				...
				<div class="hub-sol">
                    ...
                    <a href="<?php echo get_bloginfo('home'); ?>/a-detronic-energia" style="text-decoration: none;">
                        <span class="hub-title">a detronic</span>
                    </a>
                    <a href="<?php echo get_bloginfo('home'); ?>/hub-de-energia" style="text-decoration: none;">
                        <span class="hub-title">hub de energia</span>
					...
					<a href="https://portal.kula.jobs/jobs?alias=detronic"> <span class="hub-title">Trabalhe Conosco</span> </a>
                    ...
                    <div class="sol-topics">
						...
						<a href="<?php echo get_bloginfo('home'); ?>/outras-solucoes-sustentaveis"
                           style="text-decoration: none;">
                            <div class="sol-topics-txt">Outras soluções em energia</div>
                        </a>
                    </div>
				...
				*/?>
                <div class="contato">
                    ...
                    <div class="contato-list">
                        <div class="contact">
                            <div class="contact-align">
                                <img src="<?php echo get_template_directory_uri(); ?>/icons/footer/icon-2.png" style="max-width:15px;"
                                     alt="">
                                <div class="contact-align-2">
                                    <span>Telefone:</span>
                            ...
                            <div class="contact-align">
                                <img src="<?php echo get_template_directory_uri(); ?>/icons/footer/icon-1.png"  style="max-width:15px;"
                                     alt="">
                                <div class="contact-align-2">
                                    <span>Whatsapp</span>
                            ...
                            <div class="contact-align">
                                <img src="<?php echo get_template_directory_uri(); ?>/icons/footer/icon-3.png"  style="max-width:15px;"
                                     alt="">
                                <div class="contact-align-2">
                                    <span>E-mail:</span>
                                    <a href="mailto: contato@detronicenergia.com"
								...
								<a href="https://detronicenergia.com/wp-content/uploads/2023/07/CAMPANHA-DETRONIC-ATUALIZACAO-DE-DADOS-CADASTRAIS.docx.pdf" target="_blank" 											   style="font-weight: bold; color: gray; text-decoration: none;">
...
if(@$_GET['acao']=='concordo-politica-de-privacidade'){
	$_SESSION['aceite-cookies']	=	1;	
}

if ( $_SESSION['aceite-cookies'] != '1') {
	
    echo '	<div class="aceite-cookies">
				Utilizamos cookies e tecnologias semelhantes de acordo<br> com a nossa <a style="text-decoration:underline;color:#FFF;" href="https://detronicenergia.com/politica-de-privacidade/">Política de Privacidade</a>,<br>ao continuar navegando, você concorda com estas condições.
				<br>
				<div id="btn-concordo" class="btn-calc4" style="color:#000;text-decoration: none;font-size: 16px;font-weight: 700;font-family: \'Work Sans\', sans-serif;">
					Concordo e fechar
				</div>
			</div>';
}
...
<script>
	//aceite-cookies-sessao.php
	//./?acao=concordo-politica-de-privacidade
	$('#btn-concordo').click(function(){
		
		$.getJSON( "aceite-cookies-sessao.php?acao=concordo-politica-de-privacidade", function( data ) {
		  //alert('');
		});
		//alert('');
		$('.aceite-cookies').hide();
