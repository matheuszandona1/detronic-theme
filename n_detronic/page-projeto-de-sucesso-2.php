...
<img  src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/pag-2/FULLBANNER - PROJETO 02 - LAPAO-BA.jpg" alt="" style="width:100%;">

<div class="container sucesso text-center d-flex">
    <span class="energia-sub ">
        Lapão / BA
    </span>
    <span class="faq-sub">Usina Fotovoltaica de 300 kWp de potência.</span>
    <div class="sucesso-div">
        <div class="sucesso-div-1">
            <span class="parc-project">
				Usina implantada em Lapão/BA. A energia é gerada de forma remota para atender unidades consumidoras de uma construtora localizada no estado. Este é um projeto muito importante para a Detronic Energia pois ofertamos ao cliente a possibilidade de construir o projeto dentro do instituto Água Viva, e desta forma proporcionar uma nova renda ao instituto referente ao pagamento do arrendamento e contribuir com mais empregos para operação da usina. 
			</span>
        </div>
        ...
        <div class="sucesso-div-2">
            ...
            <div class="quadro-sucesso-dir">
                <span class="sucesso-dir">DTC0002 - MRV-Lapão -BA</span>
                <span class="sucesso-dir">900 módulos de 335Wp</span>
                <span class="sucesso-dir">4 inversores de 60 kW</span>
                <span class="sucesso-dir">301,5 kWp</span>
                <span class="sucesso-dir">240 kW</span>
                <span class="sucesso-dir">2.600 m²</span>
                <span class="sucesso-dir">Lapão/BA</span>
                <span class="sucesso-dir">41.436,42 kWh/mês</span>
            </div>
        </div>
    </div>
	<div class="usinas-col">
        <div class="usinas-row">
            <img class="img-resize" src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/pag-2/MRV1.JPG" alt="">
            <img class="img-resize" src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/pag-2/MRV2.JPG" alt="">
            <img class="img-resize" src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/pag-2/MRV3.jpeg" alt="">
        </div>
    </div>
...
<div class="call_calc" style="padding: 30px;">
    ...
    <button type="button" class="btn-calc4" style="text-decoration: none;" data-toggle="modal"
