...
<!--<img src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/peb/02.jpg" alt="" style="width:100%">-->

<div class="container sucesso text-center d-flex">
    <span class="energia-sub ">
        Paraopeba/MG
    </span>
    <span class="faq-sub">Usina fotovoltaica 6.464 módulos de 540 Wp</span>
    ...
    <div class="usinas-col">
        <div class="usinas-row">
            <img class="img-resize" src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/peb/01.jpg"
                 alt="">
            <img class="img-resize" src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/peb/02.jpg">
        </div>
    </div>
