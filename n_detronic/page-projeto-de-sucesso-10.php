...
<img src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/pag-2/FULLBANNER - PROJETO 10 - CAETANOPOLIS-MG.jpg" alt="" style="width:100%;">

<div class="container sucesso text-center d-flex">
    <span class="energia-sub ">
        Caetanópolis /MG
    </span>
    <span class="faq-sub">Usina Fotovoltaica de 3.477 kWp de potência.</span>
    <div class="sucesso-div">
        <div class="sucesso-div-1">
            <span class="parc-project">
				Usina em implantação em Caetanópolis/MG. A energia gerada pela usina será entregue à cooperativa da Detronic Energia para ser compartilhada com múltiplos consumidores residenciais, proporcionando ao consumidor final a possibilidade de usufruir de uma energia limpa e renovável e mais acessível. 
			</span>
        </div>
        <div class="sucesso-div-2">
            ...
            <div class="quadro-sucesso-dir">
                <span class="sucesso-dir">DTC0132 – CAE01</span>
                <span class="sucesso-dir">6.438 de 540 Wp</span>
                <span class="sucesso-dir">12 inversores de 200 kW</span>
                <span class="sucesso-dir">1 inversor de 100 kW</span>
                <span class="sucesso-dir">3.477 kWp</span>
                <span class="sucesso-dir">2.500 kW</span>
                <span class="sucesso-dir">63.508 m²</span>
                <span class="sucesso-dir">Caetanópolis /MG</span>
                <span class="sucesso-dir">554,75 MWh/Mês</span>
            </div>
        </div>
    </div>
	<div class="usinas-col">
        <div class="usinas-row">
            <img class="img-resize" src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/pag-2/CAE 01 FOTO 1.JPG" alt="">
            <img class="img-resize" src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/pag-2/CAE 01 FOTO 2.JPG" alt="">
            <img class="img-resize" src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/pag-2/CAE 01 FOTO 3.JPG" alt="">
        </div>
    </div>
</div>
