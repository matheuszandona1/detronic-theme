...
<img src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/new_banner_paracatu_112.jpg" alt=""
     style="width:100%">
...
<div class="container sucesso text-center d-flex">
    ...
    <span class="faq-sub">USINA FOTOVOLTAICA 112 KWP</span>

    <div class="sucesso-div">
        <div class="sucesso-div-1">
            <span class="parc-project">Usina de 112 kWp implantada em Paracatú/MG,
   com capacidade de geração de 16.165 kWh/mês. A usina atenderá
    a um cliente da indústria de Café no modelo Auto Consumo Remoto.</span>
        </div>
        <div class="sucesso-div-2">
            ...
            <div class="quadro-sucesso-dir">
                <span class="sucesso-dir">Usina fotovoltaica 112 KWP</span>
    ...
    <div class="usinas-col">
        <div class="usinas-row">
            <img class="img-resize" src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/img1.jpg" alt="">
            <img class="img-resize" src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/img2.jpg" alt="">
            <img class="img-resize" src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/img3.jpg" alt="">
        </div>
        <div class="usinas-row">
            <img class="img-resize" src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/img4.jpg" alt="">
            <img class="img-resize" src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/img5.jpg" alt="">
            <img class="img-resize" src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/img6.jpg" alt="">
        </div>
    </div>
