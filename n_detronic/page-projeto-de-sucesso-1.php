...
<div class="container sucesso text-center d-flex">
    ...
    <span class="faq-sub">Usina Fotovoltaica com 3.200 kWp de potência.</span>
    <div class="sucesso-div">
        <div class="sucesso-div-1">
            <span class="parc-project">
				Localizada na cidade de Montes Claros tem capacidade média de geração de 527.875 kWh/mês. A energia gerada foi locada para que múltiplos consumidores se beneficiem da geração, no modelo de negócio Geração Compartilhada. A estrutura implantada foi a tracker da ALION Energy que utiliza base concretada, não exigindo fundação e permitindo a acompanhar o relevo.
			</span>
        </div>
