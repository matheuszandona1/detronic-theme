...
<div class="solucao">
    ...
    <div class="sol-items">
        ...
        <div class="sol-main">
            ...
            <a href="<?php echo get_bloginfo('home') ?>/reducao-de-ate-20-na-conta"><img
                        src="<?php echo get_template_directory_uri(); ?>/icons/pag1/info-01.png" alt=""
                        style="width: 300px;"></a>

            <img src="<?php echo get_template_directory_uri(); ?>/icons/pag1/infografico002.png"
                 style="width: 250px;"></a>

            <a href="<?php echo get_bloginfo('home'); ?>/instalacao-usina-solar"><img
                        src="<?php echo get_template_directory_uri(); ?>/icons/pag1/info-02.png" alt=""
                        style="width: 300px;"></a>

        </div>
        <!-- end /.sol-main -->

        <a href="<?php echo get_bloginfo('home'); ?>/parceiros-investidores"><img
                    src="<?php echo get_template_directory_uri(); ?>/icons/pag1/info-03.png" alt=""
                    href="<?php echo get_bloginfo('home'); ?>/parceiros-investidores" style="width: 250px;"></a>
