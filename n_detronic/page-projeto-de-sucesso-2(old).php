...
<img src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/new_banner_paracatu_172.jpg" alt="" style="width:100%">

<div class="container sucesso text-center d-flex">
    <span class="energia-sub ">
        Paracatu/MG
    </span>
    <span class="faq-sub">Usinas fotovoltaicas 172 kWp</span>
    <div class="sucesso-div">
        <div class="sucesso-div-1">
            <span class="parc-project">Duas usinas de 86 kWp, implantadas em Paracatu/MG, com capacidade de
    geração de 24.825 kWh/mês. As usinas atendem a um cliente da indústria de Café no modelo
    Auto Consumo Remoto.</span>
        </div>
        <div class="sucesso-div-2">
            ...
            <div class="quadro-sucesso-dir">
                <span class="sucesso-dir">Usinas fotovoltaicas 172 kWp</span>
                <span class="sucesso-dir"><br></span>
                <span class="sucesso-dir"><br></span>
                <span class="sucesso-dir"><br></span>
                <span class="sucesso-dir"><br></span>
                <span class="sucesso-dir"><br></span>
                <span class="sucesso-dir">PARACATU/MG</span>
                <span class="sucesso-dir"><br></span>
            </div>
        </div>
    </div>
    <div class="usinas-col">
        <div class="usinas-row">
            <img class="img-resize" src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/pag-2/img1.jpg" alt="">
            <img class="img-resize" src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/pag-2/img2.jpg" alt="">
            <img class="img-resize" src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/pag-2/img3.jpg" alt="">
        </div>
        <div class="usinas-row">
            <img class="img-resize" src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/pag-2/img4.jpg" alt="">
            <img class="img-resize" src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/pag-2/img5.jpg" alt="">
            <img class="img-resize" src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/pag-2/img6.jpg" alt="">
        </div>
    </div>
