...
<img src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/new_banner_varejista.jpg" alt="" style="width:100%">

<div class="container sucesso text-center d-flex">
    <span class="energia-sub ">
        Paracatú/MG
    </span>
    <span class="faq-sub">Usinas fotovoltaicas 61,2 kWp</span>

    <div class="sucesso-div">
        <div class="sucesso-div-1">
            <span class="parc-project">Usina de 61,2 kWp implantada em telhado metálico na cidade de Paracatu/MG,
    com capacidade média de produção de 8508 kWh/mês.
    O Cliente também realizou o investimento em uma usina em solo para se tornar auto suficiente em energia.</span>
        </div>
        <div class="sucesso-div-2">
            ...
            <div class="quadro-sucesso-dir">
                <span class="sucesso-dir">Usinas fotovoltaicas 61,2 kWp</span>
                <span class="sucesso-dir"><br></span>
                <span class="sucesso-dir"><br></span>
                <span class="sucesso-dir"><br></span>
                <span class="sucesso-dir"><br></span>
                <span class="sucesso-dir"><br></span>
                <span class="sucesso-dir">Paracatú/MG</span>
                <span class="sucesso-dir"><br></span>
            </div>
        </div>
    </div>
    <div class="usinas-col">
        <div class="usinas-row">
            <img class="img-resize" src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/pag-4/img1.jpg" alt="">
            <img class="img-resize" src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/pag-4/img2.jpg" alt="">
            <img class="img-resize" src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/pag-4/img3.jpg" alt="">
        </div>
        <div class="usinas-row">
            <img class="img-resize" src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/pag-4/img4.jpg" alt="">
            <img class="img-resize" src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/pag-4/img5.jpg" alt="">
            <img class="img-resize" src="<?php echo get_template_directory_uri(); ?>/icons/sucesso/pag-4/img6.jpg" alt="">
        </div>
    </div>
